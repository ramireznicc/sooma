...
const Hero = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center bg-gradient-to-br from-secondary-900 via-secondary-800 to-secondary-900 text-white overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0">
        {/* Gradient orbs */}
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-secondary-600/30 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-accent-300/10 rounded-full blur-3xl" />
      ...
      <div className="container-custom relative z-10 w-full px-4">
        <div className="py-12 md:py-20 lg:py-24 flex flex-col items-center">
          ...
          <div className="flex flex-col gap-4 justify-center items-center">
            <a
              href="#contacto"
              className="btn bg-accent-300 text-secondary-900 hover:bg-accent-400 shadow-xl shadow-accent-300/20 inline-flex items-center justify-center gap-2 font-semibold"
            >
            ...
            <a
              href="#servicios"
              className="btn border border-white/20 text-white hover:bg-white/5 hover:border-white/30 inline-flex items-center justify-center backdrop-blur-sm"
            >
              Ver servicios
            </a>
          </div>
